...
const LoginModal = ({ onClose, openSignupModal }) => {
      ...
      {isGoogleLogin ? (
        ...
        >
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md relative">
            <h2 className="text-2xl font-semibold mb-4 text-center">התחברות</h2>
            <form>
              ...
              <div className="flex flex-col items-center">
                ...
                <a
                  ...
                  className="mt-2 inline-block align-baseline font-bold text-sm text-pink-500 hover:text-pink-700"
                >
                  שכחתי סיסמא
                </a>
              </div>
